...
//        });
        ...
        (root).findViewById(R.id.web).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openLink("http://hackstarz.anjaccoe.org/");
            }
        });
        (root).findViewById(R.id.whats).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openLink("https://chat.whatsapp.com/HNEM5P8QHnl1hGPRXy0WB7");
            }
        });
